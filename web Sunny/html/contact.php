        ...
        <div class="body-contact">
            <div class="wrapper-contact">
                <section class="section">
                        ...
                        <form action="" id="form">
                            ...
                            <div class="box-information">
                                <div class="enter-information">
                                    <label for="fullname" class="label">Họ và tên: <sup>*</sup></label>
                    ...
                    <div class="map">
                        <p> Địa chỉ: Khu 1, xã Xuân Lộc, huyện Thanh Thủy, Tỉnh Phú Thọ</p>
                        <strong>Hotline: 0988760407</strong>
                        <br>
                        <strong>Email: lopveSunny@gmail.com</strong>
                        <img src="/image/lop ve.jpg" alt="loading..." width="500">
                    </div>
                </section>
            </div>
        </div>
        ...
        <footer>
                ...
                <div class="footer2">
                    <div class="footer2-content">
                        <p><i class="fa-solid fa-house-chimney"></i>Lớp vẽ Sunny</p>
                        <p><i class="fa-solid fa-phone"></i>Hotline: 0988760407</p>
